...
style.configure("TNotebook.Tab", background="#bbdefb", foreground="#263238", font=('Helvetica', 10, 'bold'), padding=[10, 5], relief="flat")
...
style.configure("TButton", background="#81d4fa", foreground="#000000", font=('Helvetica', 10, 'bold'), borderwidth=1, relief="solid")
style.map("TButton", background=[("active", "#4fc3f7"), ("disabled", "#bbdefb")], foreground=[("disabled", "#263238")])
