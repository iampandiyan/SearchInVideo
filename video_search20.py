...
EARLY_EXIT_TIME = 120  # seconds (2 minutes)
...
for video_name in video_files:
    ...
    while cap.isOpened() and frame_count < MAX_FRAMES:
        ...
        if elapsed_time > EARLY_EXIT_TIME and not match_found:
            print(f"⏩ No match found in first {EARLY_EXIT_TIME} seconds. Skipping {video_name}.")
            break
